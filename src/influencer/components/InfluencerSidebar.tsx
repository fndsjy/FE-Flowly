...
const getInfluencerMenuIcon = (resourceKey: string) => {
  ...
  if (normalized === "INFLUENCER_LEARNING" || normalized.includes("LEARNING")) {
    ...
    <>
      {!isDesktop && !isOpen ? (
        <button
          ...
          aria-label="Buka sidebar influencer"
        >
          <svg
      ...
      {!isDesktop && isOpen ? (
        <button
          ...
          aria-label="Tutup sidebar influencer"
        />
      ) : null}
            ...
            <div key={item.id} className="group relative overflow-hidden">
              <Link
                ...
                className={`flex w-full items-center rounded-lg p-3 transition-colors ${
                  active
                    ? isOpen
                      ? "border border-white/35 bg-gradient-to-r from-[#f97316] via-gray-950 to-gray-950 pr-8 font-semibold text-white"
                      : "rounded-lg border border-white/35 bg-gradient-to-r from-[#f97316] via-gray-950 to-gray-950 font-semibold text-white"
