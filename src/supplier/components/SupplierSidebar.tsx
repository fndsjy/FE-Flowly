  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-gray-700 p-4">
        {isOpen && (
          <Link to="/supplier" className="mx-auto transition-transform hover:scale-105">
            <img
            ...
            <div key={item.id} className="group relative overflow-hidden">
              <Link
                ...
                className={`flex w-full items-center rounded-lg p-3 transition-colors ${
                  active
                    ? "rounded-l-lg rounded-r-none border border-r-0 border-white/45 bg-gradient-to-r from-[#1f7a8c] via-gray-900 to-gray-900 font-semibold text-white"
              ...
              {active && isOpen ? (
                <div
                  className="absolute right-0 top-1/2 h-0 w-0 -translate-y-1/2 border-b-[24px] border-r-[24px] border-t-[24px] border-b-gray-900 border-r-[#eef4f8] border-t-gray-900"
                  aria-hidden="true"
                ></div>
              ) : null}
