...
const getAffiliateMenuIcon = (resourceKey: string) => {
  ...
  if (normalized === "AFFILIATE_LEARNING" || normalized.includes("LEARNING")) {
    ...
    <>
      {!isDesktop && !isOpen ? (
        <button
          ...
          aria-label="Buka sidebar affiliate"
        >
          <svg
      ...
      {!isDesktop && isOpen ? (
        <button
          ...
          aria-label="Tutup sidebar affiliate"
        />
      ) : null}
            ...
            <div key={item.id} className="group relative overflow-hidden">
              <Link
                ...
                className={`flex w-full items-center rounded-lg p-3 transition-colors ${
                  active
                    ? isOpen
                      ? "border border-white/35 bg-gradient-to-r from-[#0f766e] via-gray-950 to-gray-950 pr-8 font-semibold text-white"
                      : "rounded-lg border border-white/35 bg-gradient-to-r from-[#0f766e] via-gray-950 to-gray-950 font-semibold text-white"
